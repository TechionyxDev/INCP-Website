...
export function SecuritySection() {
  ...
  return (
    <section id="security" className="py-section border-t border-[var(--border)]">
      <div className="mx-auto max-w-6xl px-gutter">
        ...
        <div className="mt-section-gap grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-8 sm:gap-y-10">
          {securityItems.map((item, idx) => (
            <ScrollReveal key={item.title} delay={idx * 80}>
              <div className="pt-5 sm:pt-6 border-t border-[var(--border)]">
                ...
                <h3 className="mt-4 text-base sm:text-lg font-semibold text-[var(--text)]">
                  {item.title}
                </h3>
