...
export function NetworkCalculator() {
  ...
  return (
    <section id="calculator" className="relative py-28 sm:py-36 border-t border-[var(--border)] bg-[var(--bg-soft)]">
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6">
        <div className="max-w-3xl">
          ...
          <ScrollReveal delay={100}>
            <h2 className="mt-5 text-3xl sm:text-5xl font-extrabold tracking-tight text-[var(--text)] leading-[1.1] font-sans">
              ...
              <span className="text-scarlet">with coordinated inventory states.</span>
            </h2>
          </ScrollReveal>
        ...
        <ScrollReveal delay={300} className="mt-14">
          <div className="rounded-3xl border-2 border-crimson/50 bg-black p-6 sm:p-10 shadow-2xl">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              {/* Left Column: Sliders (6 cols) */}
              <div className="lg:col-span-6 space-y-8">
                <div>
                  <div className="flex items-center justify-between text-sm font-mono text-white mb-3">
                    <span className="text-silver uppercase tracking-wider">Number of Operating Locations:</span>
                    <span className="text-xl font-bold text-scarlet">{locations} Nodes</span>
                  </div>
                  <input
                    type="range"
                    min="2"
                    ...
                    className="w-full h-2.5 bg-[var(--bg-soft)] rounded-lg appearance-none cursor-pointer accent-scarlet border border-[var(--border)]"
                  />
                  <div className="flex justify-between text-[10px] font-mono text-silver mt-1.5">
                ...
                <div>
                  <div className="flex items-center justify-between text-sm font-mono text-white mb-3">
                    <span className="text-silver uppercase tracking-wider">Monthly Inventory Movement:</span>
                    <span className="text-xl font-bold text-scarlet">
                ...
                <div className="p-4 rounded-2xl bg-[var(--bg-soft)] border border-[var(--border)] font-mono text-xs text-silver space-y-2">
                  <div className="text-white font-bold flex items-center gap-2">
                    <ShieldCheck className="h-4 w-4 text-scarlet" />
              ...
              <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="sm:col-span-2 p-6 rounded-2xl border border-scarlet/40 bg-crimson/20">
                  <div className="flex items-center gap-2 text-xs font-mono text-scarlet uppercase tracking-wider font-bold">
                    <DollarSign className="h-4 w-4" />
                    Estimated Capital Loss Prevented / Year
                  </div>
                  <div className="text-3xl sm:text-5xl font-black text-white font-mono mt-2 tracking-tight">
                    ${annualSavedShrinkage.toLocaleString()}
                  </div>
                  <p className="text-xs text-silver mt-2 font-mono">
                    Eliminating unverified transfer loss and unrecorded shift consumption drift.
                  </p>
                </div>

                {/* Metric 2: Labor Hours Saved */}
                <div className="p-5 rounded-2xl border border-[var(--border)] bg-[var(--bg-soft)]">
                  <div className="flex items-center gap-2 text-xs font-mono text-silver uppercase font-semibold">
                    <Clock className="h-4 w-4 text-scarlet" />
                    Audit Labor Saved
                  </div>
                  <div className="text-2xl sm:text-3xl font-extrabold text-white font-mono mt-2">
                    {hoursSavedPerYear.toLocaleString()} <span className="text-xs text-silver font-normal">hrs/yr</span>
                  </div>
                  <p className="text-[11px] text-silver mt-1">Manual monthly spreadsheet counts replaced.</p>
                </div>

                {/* Metric 3: Stockout Risk Reduction */}
                <div className="p-5 rounded-2xl border border-[var(--border)] bg-[var(--bg-soft)]">
                  <div className="flex items-center gap-2 text-xs font-mono text-silver uppercase font-semibold">
                    <Zap className="h-4 w-4 text-scarlet" />
                    Stockout Prevention
                  </div>
                  <div className="text-2xl sm:text-3xl font-extrabold text-white font-mono mt-2">
                    {stockoutRiskReduction}%
                  </div>
                  <p className="text-[11px] text-silver mt-1">Lead time curves prevent emergency downtime.</p>
                </div>
              </div>
            </div>
          </div>
